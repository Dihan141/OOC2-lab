...
public class ShamelessGreenTest {
    ...
    public void Testverse3_99()
    {
        ...
        expected = "30 bottles of beer on the wall, 30 bottles of beer.\n" +
                "Take one down and pass it around, 29 bottles of beer on the wall.\n";

        assertEquals(expected, shamelessGreen.Verse(30));
    ...
    public void Testverses()
    {
        ...
        ShamelessGreen shamelessGreen = new ShamelessGreen();
        assertEquals(expected, shamelessGreen.Verses(5, 0));
    }
    ...
    public void TestSong()
    {
        ...
        ShamelessGreen shamelessGreen = new ShamelessGreen();
        assertEquals(expected, shamelessGreen.Song());
    }

    @Test
    public void Testlimits()
    {
        String expected = "upper limit must be higher.";

        ShamelessGreen shamelessGreen = new ShamelessGreen();
        assertEquals(expected, shamelessGreen.Verses(7, 15));
    }

    @Test
    public void TestNegValues()
    {
        String expected = "values can't be negative.";

        ShamelessGreen shamelessGreen = new ShamelessGreen();
        assertEquals(expected, shamelessGreen.Verses(-5, 15));
        assertEquals(expected, shamelessGreen.Verses(5, -3));
    }

    @Test
    public void TestNegVerse()
    {
        String expected = "verse number can't be negative.";

        ShamelessGreen shamelessGreen = new ShamelessGreen();
        assertEquals(expected, shamelessGreen.Verse(-5));
    }
}
